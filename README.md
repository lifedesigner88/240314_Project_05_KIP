...
- 기본 관리자 계정: `k-1234567890 / 1234` (`소마멘토`)
- 추가 데모 계정: `k-2403140001 / 1234`, `k-2403140002 / 1234`, `k-2403140003 / 1234`, `k-2403140004 / 1234`, `k-2403140005 / 1234`, `k-2403140006 / 1234`, `k-2403140007 / 1234`
- 기본 더미데이터: `AI 소프트웨어 마에스트로 데모` 그룹 트리, 공개 문서, 백엔드/프론트엔드/AI 실험 문서, 권한 요청 샘플 자동 주입
